...
# IMPORTANT: Install Xvid codec beforehand! Otherwise video will not be saved correctly!
...
class VideoAcq(object):
    def __init__(self):
         #gain and exposure have to be hardcoded for some reason below
    ...
    def listCapDev(self):
        ...
        while True:
            ...
            k += 1
        n = k
        print("This error is irrelevant and based on bad coding. ;)")
    ...
    def capture(self, record = False):
        ...
        for dev in devIndices:
            print(dev)
            cap_i = []
            cap_i = EasyPySpin.VideoCapture(dev)
...
def setDevParameters(cap, parameters):
    ...
    #gain and exposure have to be hardcoded for some reason
